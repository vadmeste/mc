...
func checkAdminHealRunSyntax(ctx *cli.Context) {
	if len(ctx.Args()) != 1 {
...
// mainAdminHealRun - the entry function of heal run command
func mainAdminHealRun(ctx *cli.Context) error {

	// Check for command syntax
	checkAdminHealRunSyntax(ctx)
